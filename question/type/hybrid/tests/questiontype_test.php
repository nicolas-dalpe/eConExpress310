...
/**
 * Unit tests for the hybrid question type class.
 *
 * @package    qtype
 * @subpackage hybrid
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_hybrid_test extends advanced_testcase {
    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_hybrid();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'hybrid');
    }
