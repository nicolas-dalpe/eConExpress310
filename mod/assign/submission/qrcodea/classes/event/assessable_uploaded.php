...
/**
 * The assignsubmission_qrcodea assessable uploaded event.
 *
...
/**
 * The assignsubmission_qrcodea assessable uploaded event class.
 *
 * @package    assignsubmission_qrcodea
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has uploaded a file to the QR Code assignment submission with id '$this->objectid' " .
    ...
    public static function get_legacy_eventname() {
        return 'qrcodea_assessable_file_uploaded';
    }
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'assignsubmission_qrcodea');
    }
