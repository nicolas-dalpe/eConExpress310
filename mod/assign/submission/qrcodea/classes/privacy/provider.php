...
namespace assignsubmission_qrcodea\privacy;
...
class provider implements
    ...
    public static function export_submission_user_data(assign_plugin_request_data $exportdata) {
        ...
        $plugin = $assign->get_plugin_by_type('assignsubmission', 'qrcodea');
    ...
    public static function delete_submission_for_context(assign_plugin_request_data $requestdata) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($requestdata->get_context()->id, 'assignsubmission_qrcodea', ASSIGNSUBMISSION_QRCODEA_FILEAREA);

        // Delete records from assignsubmission_qrcodea table.
        $DB->delete_records('assignsubmission_qrcodea', ['assignment' => $requestdata->get_assign()->get_instance()->id]);
    }
    ...
    public static function delete_submission_for_userid(assign_plugin_request_data $deletedata) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($deletedata->get_context()->id, 'assignsubmission_qrcodea', ASSIGNSUBMISSION_QRCODEA_FILEAREA,
                $submissionid);

        $DB->delete_records('assignsubmission_qrcodea', ['assignment' => $deletedata->get_assignid(), 'submission' => $submissionid]);
    }
    ...
    public static function delete_submissions(assign_plugin_request_data $deletedata) {
        ...
        $fs->delete_area_files_select($deletedata->get_context()->id, 'assignsubmission_qrcodea', ASSIGNSUBMISSION_QRCODEA_FILEAREA,
                $sql, $params);

        $params['assignid'] = $deletedata->get_assignid();
        $DB->delete_records_select('assignsubmission_qrcodea', "assignment = :assignid AND submission $sql", $params);
    }
}
