 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignsubmission_qrcodea_locallib_testcase extends advanced_testcase {
    ...
    public function test_submission_is_empty($data, $expected) {
        ...
        $assign = $this->create_instance($course, [
                'assignsubmission_qrcodea_enabled' => 1,
                'assignsubmission_qrcodea_maxfiles' => 12,
                'assignsubmission_qrcodea_maxsizebytes' => 10,
            ]);
