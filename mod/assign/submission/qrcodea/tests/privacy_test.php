...
/**
 * Unit tests for assignsubmission_qrcodea.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class assignsubmission_qrcodea_privacy_testcase extends \mod_assign\tests\mod_assign_privacy_testcase {
    ...
    protected function create_file_submission($assign, $student, $filename) {
        ...
        $pdfsubmission = (object) array(
            ...
            'component' => 'assignsubmission_qrcodea',
            'filearea' => assignsubmission_qrcodea_FILEAREA,
    ...
    public function test_get_metadata() {
        $collection = new \core_privacy\local\metadata\collection('assignsubmission_qrcodea');
        $collection = \assignsubmission_qrcodea\privacy\provider::get_metadata($collection);
    ...
    public function test_export_submission_user_data() {
        ...
        \assignsubmission_qrcodea\privacy\provider::export_submission_user_data($exportdata);
        // print_object($writer);
    ...
    public function test_delete_submission_for_context() {
        ...
        \assignsubmission_qrcodea\privacy\provider::delete_submission_for_context($requestdata);
    ...
    public function test_delete_submission_for_userid() {
        ...
        \assignsubmission_qrcodea\privacy\provider::delete_submission_for_userid($requestdata);
        // This checks that there are no files in this submission.
        $this->assertTrue($plugin->is_empty($submission));
    ...
    public function test_delete_submissions() {
        ...
        $data = $DB->get_records('files', ['contextid' => $context1->id, 'component' => 'assignsubmission_qrcodea']);
        $this->assertCount(6, $data);

        $data = $DB->get_records('assignsubmission_qrcodea', ['assignment' => $assign1->get_instance()->id]);
        $this->assertCount(3, $data);

        // Records in the second assignment (not being touched).
        $data = $DB->get_records('assignsubmission_qrcodea', ['assignment' => $assign2->get_instance()->id]);
        ...
        \assignsubmission_qrcodea\privacy\provider::delete_submissions($deletedata);
        $data = $DB->get_records('files', ['contextid' => $context1->id, 'component' => 'assignsubmission_qrcodea']);
        $this->assertCount(2, $data);
