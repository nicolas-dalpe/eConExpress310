@mod @mod_assign @assignsubmission_qrcodea
Feature: In an assignment, limit submittable file types
  ...
  Background:
    ...
    And the following config values are set as admin:
      | filetypes | image/png;spreadsheet | assignsubmission_qrcodea |

  @javascript
  Scenario: File types validation for an assignment
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | assignsubmission_onlinetext_enabled | assignsubmission_qrcodea_enabled | assignsubmission_qrcodea_maxfiles | assignsubmission_qrcodea_maxsizebytes |
  ...
  Scenario: Uploading permitted file types for an assignment
    Given the following "activities" exist:
      | activity | course | idnumber | name                 | intro                       | duedate    | assignsubmission_onlinetext_enabled | assignsubmission_qrcodea_enabled | assignsubmission_qrcodea_maxfiles | assignsubmission_qrcodea_maxsizebytes | assignsubmission_qrcodea_filetypes |
